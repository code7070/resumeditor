      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full p-2.5 border border-gray-200 rounded-lg focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition-all placeholder:text-gray-400"
        ...
        <div className="space-y-1 md:col-span-2">
          <div className="text-xs font-semibold text-gray-500 uppercase block tracking-wider">
            Alignment
          </div>
                    ...
                    {(provided) => (
                      ...
                      >
                        ...
                        <input
                          ...
                          className="flex-1 p-2 border border-gray-200 rounded-lg focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none text-sm placeholder:text-gray-400"
                          placeholder="Label"
                        />
                        <input
                          type="text"
                          ...
                          className="flex-2 p-2 border border-gray-200 rounded-lg focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none text-sm placeholder:text-gray-400"
                          placeholder="URL"
                        />
                        <button
